...
const upgrade: FaceUpgrade = {
  ...
  tiers: [
    ...
    { effects: [{ verb: 'fireProjectile', count: 1, pierce: 99, size: 2.2, damageMul: 4.0 }], damageMul: 1.0 },
    ...
    { effects: [{ verb: 'fireProjectile', count: 2, pierce: 99, size: 2.4, damageMul: 5.5 }, { verb: 'applyStatus', status: 'burn', power: 3, duration: 2 }], damageMul: 1.0 },
