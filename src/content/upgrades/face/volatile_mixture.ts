...
const upgrades: FaceUpgrade[] = [
  {
    ...
    effect: { effects: [{ verb: 'modifyProjectile', aoeOnHit: 18, burnDps: 3, burnDur: 2 }, { verb: 'groundZone', radius: 26, dps: 3, duration: 0.9, element: 'poison', slow: 0.1 }], damageMul: 1.0 },
  },
  {
    ...
    animation: { cast: 'transmute_glow', projectile: 'toxin_proj', hit: 'explosion_small', evolution: 'nova_bloom' },
    icon: ['..............','......66......','.....6dd6.....','....6dzzd6....','...6dzuuzd6...','..6dzuuuzd6...','..6dzzzzd6...','...6dddd6....','....6666.....','.....uu......','....u..u.....','..............','..............','..............'],
    effect: { effects: [{ verb: 'modifyProjectile', aoeOnHit: 24, burnDps: 5, burnDur: 3 }, { verb: 'groundZone', radius: 34, dps: 5, duration: 1.2, element: 'poison', slow: 0.18 }, { verb: 'flamePillar', count: 1, radius: 16, damageMul: 0.35, duration: 0.55 }], damageMul: 1.0 },
  },
  {
