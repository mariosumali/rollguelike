...
const SFX: Record<SfxId, () => void> = {
  ...
  ui_click: () => {
    playTone({ wave: 'square', freq: 880, duration: 0.04, volume: 0.12 });
  },
  ui_reroll: () => {
    playTone({ wave: 'square', freq: 440, freqEnd: 660, duration: 0.08, volume: 0.15 });
    playTone({ wave: 'square', freq: 660, freqEnd: 880, duration: 0.08, volume: 0.12 });
  },
  upgrade_pick: () => {
